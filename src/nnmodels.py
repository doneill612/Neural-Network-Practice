...
def fc_layer(_input, channels_in, channels_out, output = False):
    ...
    applied to the output. This is not the case in all network models.
    """
...
def network_model():
    ...
    but more layers could have easily been added with additional calls of
    `fc_layer`.
    """
...
def main():
    """
    Constructs, trains, and tests the model.
    The network achieves 97.85\\%\\accuracy on average!
    """
